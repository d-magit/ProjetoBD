class Avaliacao:
    ...
    def UpdateEvaluation(self, evaluation):
        ...
        return self.__sqlManager.ExecuteQuery(f"UPDATE Avaliacao SET {values} WHERE Numero_Aval = {evaluation['Numero_Aval']}")
    
    def DeleteEvaluation(self, evalId):
        return self.__sqlManager.ExecuteQuery(f"DELETE FROM Avaliacao WHERE Numero_Aval = {evalId}")